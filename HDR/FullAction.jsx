...
function run() {
    ...
    //Add light
    var buttonAddLight = group2.add("button", undefined, undefined, { name: "Add sky (2)" });
    ...
    //Save selection detail
    var buttonSelectionDetail = group2.add("button", undefined, undefined, { name: "Flip_Canvas_Product_White" });
    ...
    var buttonSaveTifDTD = group2.add("button", undefined, undefined, { name: "Hair Fly" });
    ...
    //         runScript(currentFolder + "/mergeIndor.jsx");
    ...
    //     dialogsedfasdfasdf.close();
    //     try {
    //         doc.layers.getByName("Sky").visible = false;
    //         runScript(currentFolder + "/mergeOutdor.jsx");
    //         doc.activeLayer.move(doc.layers.getByName("Sky"), ElementPlacement.PLACEAFTER);
    //         doc.layers.getByName("Sky").visible = true;
    //     } catch (error) {
    //         runScript(currentFolder + "/mergeOutdor.jsx");
