...
function createLayerColor(endName) {
    ...
    //Tạo layer Brightness/Contrast
    activeDocument.selection.load(activeDocument.channels.getByName(endName));
    
    makeBrightnessContrast();

    // re_name_Layer(activeDocument.activeLayer.name + endName);
    activeDocument.activeLayer.name = "Acad - Brightness - " + endName;
    ...
    makeColorBalance();
    // re_name_Layer(activeDocument.activeLayer.name + endName);
    activeDocument.activeLayer.name = "Acad - Color Balance - " + endName;
    setColorLayer(colorLayerRandum);
