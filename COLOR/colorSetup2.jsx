...
function createLayerColor(endName) {
    ...
    //Tạo layer Curves ...  từ vùng chọn
    activeDocument.selection.load(activeDocument.channels.getByName(endName));
    makeCurves();
    activeDocument.activeLayer.name = "Acad - Curves........ - " + endName;
    setColorLayer(colorLayerRandum);

    // selectLayer("Resources")
    // if (activeDocument.activeLayer.artLayers.length != 0) {
    //     alert(endName)
    //     activeDocument.activeLayer.artLayers[0].name = endName 
    // }
