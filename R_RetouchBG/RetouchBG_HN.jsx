...
var fileImages = "W:/Automation by Academy/Images/Background";
...
function main() {
    ...
    if (pointLayerBG[1] != 0 || pointLayerBG[2] != 0) {
...
function colorRetouchBG() {
    if (setSelectedLayer("Desaturated Background") == true) {
        ...
        try {
            ...
            Color4Btn3.preferredSize = [50, 20];
        ...
        Color3Btn3.onClick = function () {
            dlg.close();
            setColorHueBG(false, 0, -100, 38, "color10.jpg", 80, 80);
