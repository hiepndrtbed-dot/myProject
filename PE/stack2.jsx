...
function createLayout(length, rowGutter) {
    ...
    if (length == 3) {
        desc2.putInteger(stringIDToTypeID("colCount"), 3);
        desc2.putUnitDouble(stringIDToTypeID("colGutter"), charIDToTypeID('#Pxl'), rowGutter);
    }
