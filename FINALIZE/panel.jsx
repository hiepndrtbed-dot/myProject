...
const arrProduct = ["3", "4", "Product", "PRODUCT", "product", "Model", "Retouch", "Cutout", "Produkt", "SHOE"]
const arrRetouch = ["4", "5", "Retouch", "RETOUCH", "retouch", "Skin Retouch", "", ""]
const arrGrColor = ["Color", "Color Adjustment", "Masken", "Background Mask", "Color 4"]
...
function run(variant, background, shadow, product, retouch, color, grcolor, colorFill, mask, blend) {
    ...
    // background/shadow/product/mask/color,
    // alert(grcolor)
    ...
    if (grcolor == "Masken") {
        ...
        selectGrodupLayer(nameEnd, nameStart)
        action("Mrg2")
        doc.activeLayer.name = product
    }
    ...
    if (grcolor == "Background Mask") {
        ...
        selectGrodupLayer("Retouch BG", "Product")
        action("Mrg2")
        doc.activeLayer.name = product
    }
...
function selectGrodupLayer(before, after) {
    selectLayer(before);
    var idslct = charIDToTypeID("slct");
