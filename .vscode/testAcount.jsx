            ...
            callback: window["gapi_onload"], _c: {
                url: "https://apis.google.com/js/api.js", jsl: {
                    ci: {
                        ...
                        disableRealtimeCallback: !1, drive_share: { skipInitCommand: !0 }, csi: { rate: .01 }, client: { cors: !1 }, signInDeprecation: { rate: 0 }, include_granted_scopes: !0, llang: "vi", iframes: {
                    ...
                    }, h: "m;/_/scs/abc-static/_/js/k=gapi.lb.vi.x4OJaTv-86E.O/d=1/rs=AHpOoo8eR9mDOGjq-AGe-NEJj4e4Ujbiyg/m=__features__", u: "https://apis.google.com/js/api.js", hee: !0, dpo: !1, le: ["scs"], glrp: false
...
function initClient() {
    gapi.client.init({
      ...
      // Google Sheets API is initialized and ready to be used.
      // You can make API calls here.
    }).catch(function(error) {
      alert('Error initializing Google Sheets API:', error);
    });
  }
  ...
  function getDataFromSpreadsheet() {
    gapi.client.sheets.spreadsheets.values.get({
      ...
      range: 'Sheet1!A1:D10' // Specify the sheet name and the range you want to fetch
      ...
      if (values.length > 0) {
        ...
        for (var i = 0; i < values.length; i++) {
          var row = values[i];
          // Access individual values in the row using array indexing (e.g., row[0], row[1], etc.)
          alert(row);
        }
      } else {
        alert('No data found.');
      ...
      alert('Error retrieving data from spreadsheet:', error);
    });
  }
