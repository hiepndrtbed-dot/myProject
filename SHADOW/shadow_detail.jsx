    ...
    function copy_shadow(vr) {
        ...
        for (var i = 0; i < lengthItem; i++) {
            ...
            if (searchProduct == 0) {
                ...
                selectRGB()
                try {
                    doc.pathItems.getByName(doc.activeLayer.name + " Vector Mask").deselect()
                } catch (error) {

                }
                
                if (doc.layerSets.length > 3) {
                    doc.selection.selectAll()
                } else {
                    //leftTop, leftBottom, rightBottom rightTop
                    var shapeRef = [[doc.guides[0].coordinate, doc.guides[2].coordinate], [doc.guides[0].coordinate, doc.guides[3].coordinate], [doc.guides[1].coordinate, doc.guides[3].coordinate], [doc.guides[1].coordinate, doc.guides[2].coordinate]]
